...
UINT32 S5K3P9SP_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);    //Added by Hanyue.Shao@Cam.Drv, 2018/11/1, for s5k3p9sp bring up
/* 2.Second Vendor */
...
UINT32 S5K3P9SP_GUANGZHEN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);

/* 3.Third Vendor */
UINT32 HI1336_LIANYI_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC2375H_LIANYI_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC2375H_CHENGXIANGTONG_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 HI846_DONGCI_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);

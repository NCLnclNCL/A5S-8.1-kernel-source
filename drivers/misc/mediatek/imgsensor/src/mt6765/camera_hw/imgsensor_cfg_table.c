...
/* Hanyue.Shao@Camera.Driver, 2019/01/09, add for control i2c power start */
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_SCL},
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_SDA},
...
#ifdef ODM_WT_EDIT
/* Xuegui.Bao@Camera.Driver, 2018/10/10, add for [summer af bringup] */
...
/* Hanyue.Shao@Camera.Driver, 2019/01/09, add for control i2c power end */
...
#if defined(GC8034_MIPI_RAW)
    {
        SENSOR_DRVNAME_GC8034_MIPI_RAW,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {PDN, Vol_1200, 0},    //Compatible with  GPIO_DVDD and PMIC_DVDD
            {DVDD, Vol_1200, 1},
            {AVDD, Vol_2800, 1},
...
#endif
/* Hanyue.Shao@Camera.Driver, 2018/11/3, modify for SP2509 power down sequence */
#if defined(SP2509V_MIPI_RAW)
    {
        SENSOR_DRVNAME_SP2509V_MIPI_RAW,
        {
            ...
            {SensorMCLK, Vol_High, 0},
            {PDN, Vol_Low, 5, Vol_Low, 0},
            {RST, Vol_High, 5, Vol_Low, 0}
        },
    },
#endif
/*Added by Hanyue.Shao@Cam.Drv, 2018/11/1, for s5k3p9sp bring up    start*/
#if defined(S5K3P9SP_MIPI_RAW)
    {
        SENSOR_DRVNAME_S5K3P9SP_MIPI_RAW,
        {
            ...
            {SensorMCLK, Vol_High, 1},
            {AVDD, Vol_2800, 1},
            {PDN, Vol_1100, 0},  //Compatible with  GPIO_DVDD and PMIC_DVDD
            {DVDD, Vol_1100, 1},
            {DOVDD, Vol_1800, 1},
            //{PDN, Vol_Low, 0},
            //{AFVDD, Vol_2800, 1},
...
#endif
/*Added by Hanyue.Shao@Cam.Drv, 2018/11/1, for s5k3p9sp bring up    end*/
/* 2.Second Vendor */
...
#endif
#if defined(S5K3P9SP_GUANGZHEN_MIPI_RAW)
    {
        SENSOR_DRVNAME_S5K3P9SP_GUANGZHEN_MIPI_RAW,
        {
            {RST, Vol_Low, 1},
            {SensorMCLK, Vol_High, 1},
            {AVDD, Vol_2800, 1},
...
#if defined(HI1336_LIANYI_MIPI_RAW)
	{
		SENSOR_DRVNAME_HI1336_LIANYI_MIPI_RAW,
		{
/* Hanyue.Shao@Camera.Driver, 2019/01/09, add for control i2c power start */
			{SCL, Vol_High, 0},
			{SDA, Vol_High, 10},
...
#endif
#if defined(HI846_DONGCI_MIPI_RAW)
	{
        SENSOR_DRVNAME_HI846_DONGCI_MIPI_RAW,
        {
            {RST, Vol_Low, 0},
            {DOVDD, Vol_1800, 1},
            {AVDD, Vol_2800, 1},
            {PDN, Vol_1200, 0},    //Compatible with  GPIO_DVDD and PMIC_DVDD
            {DVDD, Vol_1200, 1},   //Compatible with  GPIO_DVDD and PMIC_DVDD
            {SensorMCLK, Vol_High, 0},
            //{AFVDD, Vol_2800, 1},
            //{PDN, Vol_Low, 0},
            //{PDN, Vol_High, 0},
...
#if defined(GC2375H_MIPI_RAW)
    {
        SENSOR_DRVNAME_GC2375H_LIANYI_MIPI_RAW,
        {
            {PDN, Vol_High, 0, Vol_Low, 0},
            {DOVDD, Vol_1800, 1, Vol_Low, 5},
            //{DVDD, Vol_1800, 0},
